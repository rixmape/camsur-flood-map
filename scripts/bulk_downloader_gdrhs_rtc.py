...
With embedded urls: ( download the hardcoded list of files in the 'files =' block below)
    ...
    python ./download-all-2024-10-31_09-33-41.py

Download all files in a Metalink/CSV: (downloaded from ASF Vertex)

    python ./download-all-2024-10-31_09-33-41.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
...
class bulk_downloader:
    def __init__(self):
        ...
        self.files = [
            # "https://d3gm2hf49xd6jj.cloudfront.net/7a770b53-8dc9-467e-98da-3bdad03042e9/S1A_IW_20240526T095829_SVP_RTC10_G_gdufed_FC26.zip",
            "https://d3gm2hf49xd6jj.cloudfront.net/e6bb2a46-5ea4-4595-9a6c-2836d32969e1/S1A_IW_20241029T095831_SVR_RTC10_G_gdufed_ACD5.zip",
            # "https://d3gm2hf49xd6jj.cloudfront.net/3f609836-23dd-4026-a17a-c73e73bf2382/S1A_IW_20241029T095856_SVR_RTC10_G_gdufed_38D9.zip",
            # "https://d3gm2hf49xd6jj.cloudfront.net/4161e4df-8675-4ae0-81d4-e1307460cdd2/S1A_IW_20240526T095854_SVP_RTC10_G_gdufed_D321.zip",
        ]
            ...
            for arg in sys.argv[1:]:
                if arg == "--insecure":
                    ...
                    if os.path.isfile(arg):
                        ...
                        print(
                            f" > I cannot find the input file you specified: {arg}"
                        )
                else:
                    print(
                        f" > Command line argument '{arg}' makes no sense, ignoring."
                    )
    ...
    # Download the file
    def download_file_with_cookiejar(
        self, url, file_count, total, recursion=False
    ):
        ...
        if os.path.isfile(download_file):
            try:
                ...
                if e.code == 401:
                    ...
                    print(
                        " > Unknown Error, Could not get file HEAD: {0}".format(
                            e
                        )
                    )
        ...
        try:
            ...
            if content_disposition and len(content_disposition):
                possible_filename = re.findall(
                    "filename=(\S+)", content_disposition
                )
            ...
            print(
                "URL Error (from GET): {0}, {1}, {2}".format(e, e.reason, url)
            )
    ...
    def chunk_read(
        self, response, local_file, chunk_size=8192, report_hook=None
    ):
        file_size = self.get_total_size(response)
        bytes_so_far = 0
    ...
    def print_summary(self):
        ...
        print(
            f"  Successes: {len(self.success)} files, {self.total_bytes} bytes "
        )
